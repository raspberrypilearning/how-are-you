...
In this project you experienced two Scratch Extension blocks: `Translate`{:class="block3extensions"} and `Text to Speech`{:class="block3extensions"}. There are another nine more to get to know! Why not begin to explore them by clicking the Extension Block tab to the left of the Scratch Project. The tab looks like the example image below.
