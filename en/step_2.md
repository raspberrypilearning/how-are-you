...
+ Open the code editor. In the current `say`{:class=“block3looks”} block you say "How are things going in Palenstine?". Delete the message that is there and type in your own personal message.
